...
API_METADATA = {
    "title": "OrgBook Canada API",
    "description": "OrgBook Canada is a public, searchable directory of digital records for federally incorporated "
    "businesses in the Canada. Over time, other government "
    "organizations and businesses will also begin to issue digital records to "
    "OrgBook Canada. For example, permits and licenses issued by various government services.",
    "terms": {"url": "https://open.canada.ca/en/open-data"},
